...
public partial class SystemEntryForm : System.Web.UI.Page
{
    ...
    protected void TrigSearchProject(object sender, EventArgs e)
    {
            ...
            try
        {
            ...
            SqlConnection sc = new SqlConnection(@"Data Source=DESKTOP-08HFDJ7\\DESKTOP-CCFVS7L\SQLEXPRESS;Initial Catalog=lab3;Integrated Security=True");
            sc.Open();
            // Declare the query string.
    ...
    protected void fillGridView()
    {
        try
        {
            ...
            SqlConnection sc = new SqlConnection(@"Data Source=DESKTOP-CCFVS7L\SQLEXPRESS;Initial Catalog=lab3;Integrated Security=True");
            sc.Open();
            // Declare the query string.
