...
<center>
    ...
    <div class="jumbotron jumbotron-fluid" style="width:78%; background-color:lightblue; opacity: 0.83; border-radius:25px; padding-top:1px;">
        ...
        <div style="width:50%;">
            ...
            <br />
            <asp:Button ID="btnInsertEvent" CssClass="btn btn-primary" CausesValidation="false" runat="server" OnClick="btnInsertUser_Click" Text="Insert Event" />
        ...
        <div>
            <asp:GridView ID="grdUsers" ValidationGroup="validNewEventPost" runat="server" AutoGenerateColumns="False" DataKeyNames="EventPostID" OnRowCancelingEdit="grdUsers_RowCancelingEdit" OnRowDeleting="grdUsers_RowDeleting" OnRowEditing="grdUsers_RowEditing" OnRowUpdating="grdUsers_RowUpdating" AutoGenerateDeleteButton="True">
                <Columns> 
                    <asp:CommandField ShowEditButton="true" CausesValidation="true" ValidationGroup="validNewEventPost"/>
                    ...
                    <asp:TemplateField HeaderText="Event Title">
                        <EditItemTemplate>
                            <asp:TextBox ID="EventTitleEdit" runat="server" MaxLength="30" Text='<%# Eval("EventTitle") %>' TextMode="MultiLine" Height="22px" Width="122px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqgvTitle" ControlToValidate="EventTitleEdit" Text="(Required)" Display="Dynamic" Runat="server" Font-Bold="True" ForeColor="Red" ValidationGroup="validNewEventPost"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
