    ...
    <div class="jumbotron agent-1" style="width:78%; height:1000px; background-color:lightblue; opacity:0.88;">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Reward ID">
                 <ItemTemplate>
                    <asp:Label ID="lblgvRewardID" runat="server" Text='<%# Eval("RewardID") %>'></asp:Label>
                 </ItemTemplate>
            </asp:TemplateField>
